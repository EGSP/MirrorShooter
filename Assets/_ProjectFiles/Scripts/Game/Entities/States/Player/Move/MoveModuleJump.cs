...
namespace Game.Entities.States.Player
{
    public class MoveModuleJump : MoveModuleState
    {
        ...
        private readonly int _isWalking;
        ...
        protected override void ConstructorServer()
        {
            ...
            _targetDirection += Module.Rigidbody.transform.forward * vertical * _isWalking;

            var horizontal = ExtractHorizontalInput();
            _targetDirection += Module.Rigidbody.transform.right * horizontal * _isWalking;
        }
